function class_mean = Yeo_spider(parcel_data, varargin)
%
% Usage:
...
class_mean = array2table(ve_class.', 'VariableNames', {'Visual', 'Somatomotor', ...
                         'Dorsal attention', 'Ventral attention', 'Limbic', 'Frontoparietal', 'Default mode'});
